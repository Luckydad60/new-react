...
export const SeedForm = ({ modal, setModal }) => {
    ...
    //  function paste() {
    //     const nodeList = document.getElementsByClassName("form_input");
    //      navigator.clipboard.readText()
    //     .then((clipText) => {
    //         let data = clipText.trim().split(" ")
    //         for(let i = 0; i <= nodeList.length; i++) {
    //             nodeList[i].setAttribute('defaultValue',data[i]);
    //         }
    //     });
    // }
            ...
            <div className="form-container">
                ...
                {modal === false ? <form>
                    <div className="lg-screen">
                        <div className="row1">
                            <Form form_num="1" autofocus={true} name="one" value={email.one} onChange={handleChange} />
